                ...
                children: [
                  Expanded(
                    child: ClipRRect(
                        ...
                        child: widget.model!.itemList![0].storeImage! == null ||
                                  ...
                                  RawMaterialButton(
                                    ...
                                    onPressed: () {
                                      updateOrder(orderItem.curSelected,
                                          model.id, true, i);
                                      // if (
                                      //   // orderItem.item_otp != null &&
                                      //   //   orderItem
                                      //   //       .item_otp!.isNotEmpty &&
                                      //   //   orderItem.item_otp != "0" &&
                                      //     orderItem.curSelected ==
                                      //         DELIVERD) {
                                      //    updateOrder(orderItem.curSelected,model.id,true,i);
  ...
  Future<void> updateOrder(
    ...
    if (_isNetworkAvail) {
      try {
        ...
        // print(parameter.toString()+"___________________");
        print(parameter.toString() + "____________");
        Response response =

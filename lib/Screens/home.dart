...
class StateHome extends State<Home> with TickerProviderStateMixin {
        ...
        child: Container(
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              CUR_USERID == "" || CUR_USERID == null
                  ? Container()
                  : _getDrawerItem(12, DELETE, Icons.delete),
            ],
          ),
        ),
      ),
  ...
  accountDelete() async {
    ...
    var request = http.MultipartRequest('POST', Uri.parse('${baseUrl}delete_driver'));
    request.fields.addAll({
      'user_id': CUR_USERID.toString()
    });
    print("delete account parameter ${request.fields} ${baseUrl}delete_driver");
    ...
    if (response.statusCode == 200) {
      ...
      print("ffffffff ${finalResult} ${result}");
  ...
  Future<Null> getOrder() async {
    ...
    if (_isNetworkAvail) {
      ...
      try {
        ...
        print("${parameter}"+"_____________________");

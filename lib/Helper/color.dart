...
const Color primary = Color(0xffDF4E17);
const Color secondary=Color(0xffE2B517);
const Color fontColor=Color(0xff111111);
// const Color grad1Color=Color(0xffFFBD69);
const Color grad1Color=Color(0xffDF4E17);
...
const Color lightWhite1 = Color(0xffDF4E17);
const Color darkColor = Color(0xffDF4E17);
const Color darkColor2 = Color(0xffE2B517);
